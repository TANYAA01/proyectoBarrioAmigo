...
public class calendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Obtener la fecha actual del CalendarView y establecer el mes y año en el ActionBar
        //Calendar cal = Calendar.getInstance();
        //int currentYear = cal.get(Calendar.YEAR);
        //int currentMonth = cal.get(Calendar.MONTH);
        //String currentMonthYear = getMonthName(currentMonth) + " " + currentYear;
        //getSupportActionBar().setTitle(currentMonthYear);
    ...
    protected void onResume() {
        ...
        if (selectedDate != null) {
            // Si hay una fecha seleccionada, conviértela a milisegundos y establece el CalendarView
    ...
    private void mostrarEventos(String selectedDate) {
        ...
        eventosRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(calendar.this, android.R.layout.simple_list_item_1, eventosList);
